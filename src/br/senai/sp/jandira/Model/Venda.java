...
public class Venda {
    ...
    public boolean realizarVenda(br.senai.sp.jandira.model.Veiculo objVeiculo, br.senai.sp.jandira.model.Cliente objCliente){
    ...
    public boolean realizarFinanciamento(br.senai.sp.jandira.model.Cliente cliente, br.senai.sp.jandira.model.Veiculo veiculo){
        ...
        if (valorEntrada <= cliente.dinheiroDisponivel && valorEntrada > 0){
            ...
            System.out.println("Com entrada no valor de R$ " + valorEntrada);
            System.out.println("O valor das parcelas será de " + parcelas + "x R$" + valorParcelas);
            return  true;
